...
var Americanas = function (config) {
	...
	var getItems = function(cb) {
		...
		var scrapper = new Bundle("scrapper", {
			url: config.americanas.search_url,
			q: task.q,
		});
    ...
    //export price from $('.regular.price.clear_lfloat').text selector in americanas and americanas search
...
module.exports = new Americanas(config);